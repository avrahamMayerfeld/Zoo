...
<!-- 	Just some stuff you need -->
	...
	%>
		...
		<h1>eZoo <small>Update Schedule</small></h1>
		<hr class="wottodo">
		
		
		<form action="updatesched" method="post" class="form-horizontal">
		
		  <div class="form-group">
		    <label for="recurrence" class="col-sm-4 control-label">Recurrence</label>
		    <div class="col-sm-4">
		      <input type="text" class="form-control" recurrence="recurrence" name="recurrence" placeholder="Recurrence" />
		    </div>
		  </div>
		  <div class="form-group">
		 ...
		 <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="time" name="time" placeholder="FeedingTime" />
		    </div>
